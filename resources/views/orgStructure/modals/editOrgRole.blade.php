...
@section('modal-body')
  ...
  <div class="container">
    <div class="row chris">
      ...
      <div class="col-md-6">
        {!! Form::text('name', $role['name'], ['class' => 'form-control pull-left']) !!}
      </div>
    </div>
    <div class="row chris">
      <div class="col-md-1">
      ...
      <div class="col-md-6">
        {!! Form::select('type', ['Superintendent'=>'Superintendent', 'Administrative Officer'=>'Administrative Officer'], $role['type'], ['class' => 'pull-left form-control']) !!}
      </div>
    </div>
    <div class="row chris">
      <div class="col-md-1">
